...
{  
    // 耗时统计开关：设置环境变量 SLAM_TIMING=1 开启分阶段耗时统计，结束时打印。默认关闭（零开销）。
    ...
    // Save sparse semantic map point cloud
    SLAM.SaveMapPointsPLY("MapPoints.ply");
    SLAM.SavePersistentBoxesPLY("PersistentBoxes.ply");
