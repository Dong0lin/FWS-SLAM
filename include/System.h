...
public:
    ...
    // Viewer type: choose between Pangolin, Qt, or no visualization
    enum eViewerType{
        VIEWER_NONE     = 0,
        VIEWER_PANGOLIN = 1,
        VIEWER_QT       = 2
...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
           const eViewerType viewerType = VIEWER_PANGOLIN,
    ...
    // Save sparse map points as PLY point cloud (with semantic coloring)
